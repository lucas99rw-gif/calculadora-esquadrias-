...
st.title("Sistema Personalizado de Esquadrias v8.4")
...
with st.sidebar:
    ...
    if linha_principal == "Belissima / Suprema" and tipologia in ["Janela de Correr - 2 Folhas", "Janela de Correr - 3 Folhas", "Porta de Correr - 2 Folhas", "Porta de Correr - 3 Folhas", "Porta de Correr - 4 Folhas", "Janela Sanfonada / Italiana / Veneziana"]:
        versao_linha = st.radio("Variacao da Linha:", ["Belissima", "Belissima 40", "Belissima 65"])
        
    # TODAS AS OPCOES DE INTEGRADA QUE VOCE ENVIOU NO ARQUIVO 3
...
if st.button("⚡ Calcular Aluminios e Vidros", type="primary"):
    ...
    if linha_principal == "Belissima / Suprema":
        ...
        if tipologia == "Janela de Correr - 2 Folhas":
            ...
            # Condicionais exatas para cada variação do seu arquivo oficial
            ...
            elif var_integrada == "Dupla com Motor": f_desconto = 158.0
            ...
            itens_vidro = [
                f"Vidro Janela Integrada: 2 chapas de {larg_folha - 6.0:.0f} mm x {alt_folha - 112.0:.0f} mm"
            ]
            ...
            itens_vidro = [
                f"Vidro Porta Integrada: 2 chapas de {larg_folha - 6.0:.0f} mm x {alt_folha - 182.0:.0f} mm"
            ]
